...
import HomeDescription, { IHomeDescriptionProps } from '.';
...
const Template: Story<IHomeDescriptionProps> = (args) => {
  return <HomeDescription {...args} />;
};

export const HomeDescriptionEx = Template.bind({});

HomeDescriptionEx.args = {
  descriptionImage: {
    fluid: {
